...
function TigerCard({ goBack }) {
  return (
    <div className="feature-container">
      ...
      <h2 style={{color: '#03244D', marginBottom: '20px'}}>Digital Tiger Card</h2>
      
      {/* These classes pull the premium styling from App.css */}
      <div className="id-card">
        <div className="id-header">AUBURN UNIVERSITY</div>
        <div className="id-body">
          <div className="id-details">
            <h3>Blake Senn</h3>
            <p><strong>Student ID:</strong> 902 000 000</p>
